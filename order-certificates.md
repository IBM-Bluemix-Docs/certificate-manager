...
{{site.data.keyword.cloudcerts_short}} sends two sets of challenges for validating each domain that you're the domain owner: A dry-run challenge generated by {{site.data.keyword.cloudcerts_short}}, and a second challenge generated by Let's Encrypt.
{: note}
