...
- **IBM Cloud Internet Services como proveedor de DNS**  
  Ahora puede utilizar IBM Cloud Internet Services como proveedor de DNS y simplificar la experiencia de solicitud de certificados. [Más información sobre la solicitud de certificados](/docs/services/certificate-manager?topic=certificate-manager-order-certificates).
